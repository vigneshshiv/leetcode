...
public class BestSum {
    ...
    public static void main(String[] args) {
        ...
        logger.accept(getMsg.apply(8, "[1, 4, 5]"), targetSumCombination(8, new int[]{1, 4, 5})); // null
        ...
        */
        ...
        logger.accept(getMsg.apply(8, "[1, 4, 5]"), targetSumCombinationMemo(8, new int[]{1, 4, 5}, new HashMap<>())); // null
        logger.accept(getMsg.apply(100, "[5, 25]"), targetSumCombinationMemo(100, new int[]{5, 25}, new HashMap<>())); // null
    }
